class Euler008 : Solution {
    private var digits = "73167176531330624919225119674426574742355349194934\n" +
    ...
    override fun solve() {
        ...
        for (i in windowed.indices) {
            var product = 1L
            //chunked takes the length 13 strings from windowed and chunks them into single digit numerical values
            var chunked = windowed[i].chunked(1).map { x -> x.toLong() }
